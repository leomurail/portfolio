      ...
      <div>
        ...
        <div className="all-dates desktop">
          <motion.div className="container" style={{ x }}>
            ...
            <TimelineDate
              date="Septembre 2023"
              title="Rentrée My Digital School - Bachelor cycle web et multimédia"
            ...
            <TimelineDate
              date="Janvier 2024"
              title="Création de ma micro-entreprise - Marque CLIVER"
            ...
            <TimelineDate
              date="Mai - Juin 2024"
              title="Stage chez OC’COMUNIQUE - Développeur wordpress"
              desc="Pour avril et mai derniers, j’ai obtenu un stage en tant qu’intégrateur WordPress. Durant ce stage, j’ai appris à maîtriser WordPress comme ma poche, à mettre des produits en ligne sur un site e-commerce, à améliorer un site e-commerce, et j’ai suivi un appel avec un professionnel en SEO."
            />
            <TimelineDate
              date="Juin 2024"
              title="Première collection de ma marque"
              desc="En juin dernier, j’ai lancé le premier drop (collection) de ma marque, qui a duré un mois. Mon objectif était de sortir un tee-shirt en deux coloris, retraçant l’histoire et la vision de ma marque. Grâce à ce drop, j’ai pu réaliser une vidéo professionnelle avec un ami qui travaille dans le cinéma, ..."
            />
            <TimelineDate
              date="Avril - Septembre 2025 "
              title="Stage chez IDIX - Développeur fullstack"
              desc="D'avril à septembre 2025, l'agence IDIX m'a accueilli en tant que développeur fullstack junior. J'ai pu participer à différents projets frontend et backend, travailler sur des API et contribuer à leur solution Paddix."
            />
          </motion.div>
        </div>
        <Clock />
