export const contentAbout = [
  {
    ...
    desc: `Je suis passionné par le monde du digital.
            ...
            Ce que j’aime, c’est travailler depuis mon ordinateur, explorer de nouveaux univers et apprendre chaque jour.
            Le digital me permet de me former en continu et de repousser mes limites.
  ...
  },
  {
    ...
    desc: `J’ai commencé par apprendre le codage.
            ...
            En lançant ma marque de vêtements, j’ai élargi mes connaissances : design print, web design, vidéo, communication, storytelling et marketing digital.

            Avec My Digital School, j’ai renforcé ces compétences et acquis une vision plus globale.
