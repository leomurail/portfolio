...
export default function TotemsOverlay({
  allStates,
  setAllStates,
  selected,
  oneIsShown,
  ...
  return (
    <div className="overlay">
      <ul
        className={`btns ${isSelected && allStates[selected.current as number].click ? "display-none" : ""}`}
      >
        {btnsEl}
      </ul>
      <div
        className={`data-overlay desktop ${isSelected && allStates[selected.current as number].click ? "" : "display-none"}`}
      >
        {isSelected && (
          <>
            <Icon
