    ...
    >
      <div className="grid gap-2">
        ...
        <Input
          id="path"
          name="path"
          defaultValue={thumbnail?.path}
          required
          placeholder="Ex: /img/thumbnails/project-1.webp"
        />
      </div>
      <div className="grid gap-2">
        ...
        <Input
          id="alt"
          name="alt"
          defaultValue={thumbnail?.alt}
          required
          placeholder="Ex: Miniature du projet 1"
        />
      </div>
      <div className="grid grid-cols-2 gap-4">
        <div className="grid gap-2">
          ...
          <Input
            ...
            name="width"
            type="number"
            defaultValue={thumbnail?.width || 800}
            required
          />
        </div>
        <div className="grid gap-2">
          ...
          <Input
            ...
            name="height"
            type="number"
            defaultValue={thumbnail?.height || 600}
            required
          />
        </div>
      </div>
